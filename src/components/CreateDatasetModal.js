    ...
    this.props
      ...
      .catch(error => {
        if (
          ...
          error = {
            message:
              'A dataset with that name already exists, please try again.'
          };
        }
        ...
        <Row className="center-block">
          <form onSubmit={this.submit}>
            <FormGroup validationState={datasetValidState}>
              ...
              <HelpBlock>
                This will also be your dataset URL: data.world/{user.id}/<strong
                >
                  {title ? kebabCase(title) : 'cool-new-data'}
                </strong>
            ...
            <FormGroup>
              ...
              >
                ...
                <div className="radio-option-description">
                  Will only be shared with others you invite. Use for personal
