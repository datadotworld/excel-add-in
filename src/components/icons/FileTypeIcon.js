...
const insides = {
  graph: (
    <g>
      <path
        className="fill fillTransparent"
        d="M17.3,27.8A3.68,3.68,0,0,1,12.1,33a3.65,3.65,0,0,1,0-5.2,3.74,3.74,0,0,1,5.2,0h0Z"
      />
      <path
        className="stroke"
        d="M17.3,27.8A3.68,3.68,0,0,1,12.1,33a3.65,3.65,0,0,1,0-5.2,3.74,3.74,0,0,1,5.2,0h0Z"
      ...
      <path
        className="fill, fillTransparent"
        d="M34,26a3.69,3.69,0,0,1-3.7,3.7A3.61,3.61,0,0,1,26.7,26a3.69,3.69,0,0,1,3.7-3.7A3.74,3.74,0,0,1,34,26h0Z"
      />
      <path
        className="stroke"
        d="M34,26a3.69,3.69,0,0,1-3.7,3.7A3.61,3.61,0,0,1,26.7,26a3.69,3.69,0,0,1,3.7-3.7A3.74,3.74,0,0,1,34,26h0Z"
      ...
      <path
        className="fill, fillTransparent"
        d="M21.7,17.4a3.74,3.74,0,0,1-5.2,0,3.68,3.68,0,0,1,5.2-5.2,3.74,3.74,0,0,1,0,5.2h0Z"
      />
      <path
        className="stroke"
        d="M21.7,17.4a3.74,3.74,0,0,1-5.2,0,3.68,3.68,0,0,1,5.2-5.2,3.74,3.74,0,0,1,0,5.2h0Z"
  ...
  zip: (
    <g>
      ...
      <path
        className="fill, fillTransparent"
        d="M22,34h0a4,4,0,0,1-4-4V26h8v4a4,4,0,0,1-4,4h0Z"
      />
      <path
        className="stroke"
        d="M22,34h0a4,4,0,0,1-4-4V26h8v4a4,4,0,0,1-4,4h0Z"
  ...
  image: (
    <g>
      <path
        className="fill, fillTransparent"
        d="M17.14,18.07a4.57,4.57,0,1,1-4.57-4.57,4.57,4.57,0,0,1,4.57,4.57h0Z"
      />
      <path
        className="stroke"
        d="M17.14,18.07a4.57,4.57,0,1,1-4.57-4.57,4.57,4.57,0,0,1,4.57,4.57h0Z"
  ...
  vega: (
    <g>
      <path
        className="fill"
        d="M24.7 12.2h-4.4c-.6 0-1 .5-1 1V31c0 .6.4 1 1 1h4.4c.6 0 1-.4 1-1V13.2c0-.6-.4-1-1-1zm-8.7 11h-4.4c-.7 0-1 .5-1 1V31c0 .6.3 1 1 1H16c.6 0 1-.4 1-1v-6.7c0-.6-.4-1-1-1zm17.4-5.5H29c-.6 0-1 .5-1 1V31c0 .6.4 1 1 1h4.4c.7 0 1-.4 1-1V18.7c0-.6-.3-1-1-1z"
      />
    </g>
  ),
  other: (
      ...
      <svg className={`file-type-icon ${className}`} viewBox="0 0 45 58">
        <g className={`${insideType}Type`}>
          <g id="file">
            <path
              className="bg"
              d="M31.49,1h-29C1.65,1,1,1.65,1,2.93V56a1.51,1.51,0,0,0,1.46,1H42.54A1.51,1.51,0,0,0,44,56V14a1.38,1.38,0,0,0-.26-1.09L32.11,1.26A0.88,0.88,0,0,0,31.49,1h0Z"
            />
            <path
              className="stroke"
              d="M31.49,1h-29C1.65,1,1,1.65,1,2.93V56a1.51,1.51,0,0,0,1.46,1H42.54A1.51,1.51,0,0,0,44,56V14a1.38,1.38,0,0,0-.26-1.09L32.11,1.26A0.88,0.88,0,0,0,31.49,1h0Z"
            />
            <path
              className="stroke textboxStroke"
              d="M42.54,57H2.46A1.46,1.46,0,0,1,1,55.54V40H44V55.54A1.46,1.46,0,0,1,42.54,57h0Z"
            />
            <path
              className="fill fillTransparent"
              d="M32,2.39V13H42.61A0.51,0.51,0,0,0,43,12.12L32.88,2a0.51,0.51,0,0,0-.88.36h0Z"
            />
            <path
              className="stroke fileCornerStroke"
              d="M32,2.39V13H42.61A0.51,0.51,0,0,0,43,12.12L32.88,2a0.51,0.51,0,0,0-.88.36h0Z"
            />
            <path
              className="fill fillTransparent textboxFill"
              d="M42.54,57H2.46A1.46,1.46,0,0,1,1,55.54V40H44V55.54A1.46,1.46,0,0,1,42.54,57h0Z"
            />
          </g>
          {inside}
